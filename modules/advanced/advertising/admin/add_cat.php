...
$dbss=glob($staticvars['local_root']."modules/advertising/formats/*",GLOB_ONLYDIR);
?>
...
{
document.getElementById('name_img').innerHTML="<img src='<?=$staticvars['site_path'];?>/modules/advertising/images/check_mark.gif'>";
document.getElementById('resetdb').innerHTML="";
for(i=0;i<=num_dbs;i++)
	{
	  if (form.cat_name.value == db[i]) {
		document.getElementById('t_name').style.color="#2b2b2b";
		document.getElementById('name_img').innerHTML="<img width='20' height='20' src='<?=$staticvars['site_path'];?>/modules/advertising/images/reload.gif'>";
...
<script type="text/javascript" src="<?=$staticvars['site_path'];?>/modules/advertising/system/dtree.js"></script>
  <h3><img src="<?=$staticvars['site_path'].'/modules/advertising';?>/images/adcionar.gif" /> Adcionar
  Formato de Publicidade  </h3><br />
<table border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td>
               ...
               <h4 id="t_name">Nome do formato:</h4>
