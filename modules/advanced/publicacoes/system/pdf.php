...
<link rel="stylesheet" media="all" type="text/css" href="<?=$staticvars['site_path'];?>/modules/publicacoes/system/print.css"  />
</head>
<body>
...
<?php
include($staticvars['local_root']."modules/publicacoes/system/pdf/html2fpdf.php");
