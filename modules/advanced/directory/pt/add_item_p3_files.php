  ...
  <tr>
	<td>
		...
		<table  border="0"  width="100%" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td colspan="2"><div align="left"><font class="form_title">Os campos marcados com <font size="1" color="#FF0000">&#8226;</font> são obrigatórios</font></div></td>
		  </tr>
		  <tr height="15">
			<td colspan="2"></td>
		  </tr>
		...
		<form name="category_checkboxes" action="<?=$address.'&cod='.$cod.'&type='.$type;?>" enctype="multipart/form-data" method="post">
		...
		<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
            <td width="4%">&nbsp;</td>
	        <td width="96%"><input type="text"  size="50" maxlength="50" name="titulo" value="<?=@$_POST['titulo'];?>" /></td></tr>
		  <tr>
		    <td align="left">&nbsp;</td>
	        <td align="left">&nbsp;</td>
		  </tr>
		  <tr>
			...
			<font class="header_text_1">&nbsp; 3 - Upload de um arquivo</font><font size="3" color="#FF0000">&#8226;</font></td>
		  </tr>
		  <tr height="10">
			<td colspan="2"></td>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
		    <td><font class="body_text">O tamanho m&aacute;ximo de envio de ficheiros &eacute; de
                <?=$max_file_size;?>
Mb.<br />
Adicione o arquivo pretendido (<font color="#FF0000">
		      <?=$extensions[0][0];?>
		    </font>) </font></td>
		  </tr>
		  <tr height="10">
		  ...
		  <tr>
		    ...
		    <td><font class="body_text">
		      <input name="mod_current_cat" type="checkbox" onclick="switch_box1();" />
		      </font>
		      <input type="file"  name="ficheiro" size="50" value="<?=@$_FILES['ficheiro']['name'];?>" onchange="enable_box1();"/></td></tr>
		  <tr height="10">
            <td colspan="2"></td>
	      </tr>
		  <tr>
            <td>&nbsp;</td>
	        <td><div align="left"><font class="body_text">Ou adicione um arquivo compactado (<font color="#FF0000"> ZIP</font>)</font></div></td>
		  </tr>
		  <tr height="10">
            <td colspan="2"></td>
	      </tr>
		  <tr>
            <td>&nbsp;</td>
	        <td><font class="header_text_1">
	          <input type="checkbox" name="mod_alter_cat" onclick="switch_box2();" />
	          </font>
	          <input type="file" name="ficheiro_zip" size="50" value="<?=@$_FILES['ficheiro_zip']['name'];?>" onchange="enable_box2();" /></td></tr>
		  <tr>
		  ...
		  <tr>
			<td colspan="2" align="right"><input type="hidden" value="<?=@$_POST['user_group'];?>" name="user_group" />
<input type="image" src="<?=$staticvars['site_path'].'/images/buttons/'.$lang.'/';?>adicionar.gif" name="form_cat"></td>
		  </tr>
		</table>
		</form>
  </tr>
