	...
	<table border="0" align="left" width="100%">
		...
		<td >
		  <p align="left">
			...
			na página seguinte, demore o tempo que entender necess&aacute;rio a procurar a categoria que melhor serve  o conteúdo que pretende adicionar. Lembre-se que ao ajudar os outros est&aacute; a ajudar-se a si pr&oacute;prio. <br />
			<br />
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Para finalizar, indique um titulo bem ilustrativo, o autor e uma breve descrição que defina adequadamente o que est&aacute; a partilhar com a comunidade.<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;			</p>
...
<font class="body_text"><strong>Tipo</strong></font>&nbsp;&nbsp;&nbsp;
				...
				?>
				<img src="<?=$staticvars['site_path'];?>/modules/directory/images/clip_check.gif" width="15" height="12" />&nbsp;Pode também de definir quem &eacute; que vai poder ter acesso ao conte&uacute;do que est&aacute; agora a colocar <br />
				<font class="body_text">O conteúdo a colocar vai estar visivel para </font>
                <select size="1" name="user_group" class="form_input" >
                  <?php
							$user=$db->getquery("SELECT cod_user_type FROM users where nick='".$_SESSION['user']."'");
							$query=$db->getquery("select cod_user_type, name from user_type where cod_user_type='".$user[0][0]."'");
							unset($option);
							$option[0][0]='0';
							$option[0][1]='TODOS';
							if ($query[0][0]<>''):
