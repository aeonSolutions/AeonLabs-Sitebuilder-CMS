...
if ($enable_publish):
	$txt='O seu arquivo foi submetido com sucesso na categoria '.$type_name.' e encontra-se de momento em analise. Caso seja aprovado, ser-lhe-á enviado um email. Obrigado por ter participado!';
else:
