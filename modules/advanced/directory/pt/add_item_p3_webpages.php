  ...
  <tr>
	<td>
		...
		<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
            <td width="4%">&nbsp;</td>
	        <td width="96%"><input type="text"  size="50" maxlength="50" name="titulo" value="<?=@$_POST['titulo'];?>" /></td>
		  </tr>
		  <tr>
		    <td align="left">&nbsp;</td>
	        <td align="left">&nbsp;</td>
		  ...
		  <tr>
			...
			<font class="header_text_1">&nbsp; 3 - C&oacute;digo</font><font size="3" color="#FF0000">&#8226;</font></td>
		  </tr>
		  <tr height="10">
			<td colspan="2"></td>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
		    <td>S&oacute; &eacute; permitido codigo html </td>
		  </tr>
		  <tr height="10">
			<td colspan="2"></td>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
		    <td><textarea name="webpages" cols="50" rows="5"><?=@$_POST['webpages'];?>
            </textarea></td>
		  </tr>
		  <tr height="10">
            <td colspan="2"></td>
