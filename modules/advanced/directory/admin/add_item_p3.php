...
if (!include($staticvars['local_root'].'general/site_handler.php')):
	echo 'Error: Security Not Found (add item p3)';
	exit;
endif;
...
$tipos=$query[0][0];
if ($tipos=='modulo'):
	include($staticvars['local_root'].'modules/directory/admin/add_item_p3_modules.php');
elseif ($tipos=='linkexterno'):
	include($staticvars['local_root'].'modules/directory/admin/add_item_p3_links.php');
elseif ($tipos=='webpage'):
	include($staticvars['local_root'].'modules/directory/admin/add_item_p3_webpages.php');
