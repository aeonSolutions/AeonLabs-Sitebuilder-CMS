...
if (!include($staticvars['local_root'].'general/site_handler.php')):
	echo 'Error: Security Not Found (add item p3 modules)';
	exit;
endif;
	...
	<td>
		...
		<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<font class="header_text_1">&nbsp; 3 - M&oacute;dulo </font><font size="3" color="#FF0000">&#8226;</font></td>
		  </tr>
		  <tr height="10">
			<td colspan="2"></td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <td><?php
				...
				$selected=0;
				?>
				<select size="1" name="modules" class="form_input">
					<?php
