...
if (!isset($active)):
 ?>
<form action="<?=$address;?>" method="post" enctype="multipart/form-data" name="post" onsubmit="return checkForm(this)">	
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" >
	<tr>
	  ...
	  <td >
				...
				?>	<select name="news" class="form_input"> <?php
	  ...
	  &nbsp;<input type="submit" value=" ver "  name="active" class="form_submit"/>	  </td>
    </tr>
    </table>
<?php
elseif (isset($active)):
 ?>
<form action="<?=$address.'&update=8';?>" method="post" enctype="multipart/form-data" name="post" onsubmit="return checkForm(this)">	
<input type="hidden" name="cod_news" value="<?=@mysql_escape_string($_POST['news'])?>" />
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
		...
		<td ><input type="text" class="body_text" tabindex="1" name="username" size="25" maxlength="25" value="<?=$usr;?>" disabled="disabled"/></td>
	</tr>
	<tr>
	  <td >&nbsp;</td>
	...
	<tr>
	  ...
	  <td ><input name="up_img" type="file" class="form_input" id="up_img" size="80"></td>
    </tr>
	<tr> 
	  ...
	  <td  width="78%"> <span class="body_text"><span class="body_text">
	    <input type="text" name="subject" size="45" maxlength="60" style="width:99%" tabindex="2" class="post" value="<?=$subject;?>" />
	  </span></span> </td>
	</tr>
	<tr> 
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
		  ...
		  <tr align="center" valign="middle"> 
			<td height="50" colspan="8"> <span class="body_text"> 
			  <input type="text" name="helpbox" size="45" maxlength="100" style="width:99%; font-size:10px; text-align:center;" class="helpline" value="Ideia: Estilos podem ser aplicados rapidamente a texto seleccionado" />
			  </span></td>
		  </tr>
		  <tr> 
			<td colspan="8"><span class="body_text"> 
			  <textarea name="message" rows="15" cols="35" wrap="virtual" style="width:99%" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);"><?=$message;?></textarea>
			  </span></td>
		  </tr>
		</table>
		</span></td>
	...
	<tr> 
	  ...
	  &nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="form_submit" value="Submeter" />
	&nbsp;<input type="submit" accesskey="d" tabindex="7" name="apagar" class="form_submit" value="Apagar" />
	&nbsp;<input type="submit" class="form_submit" name="duo_active" value="<?=$tmp;?>">	  </td>
	</tr>
<?php
else:
?>
