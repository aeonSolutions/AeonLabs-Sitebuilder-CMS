...
if(isset($_FILES['add_template'])):
	include($staticvars['local_root'].'modules/congressos/update_db/web_management.php');
endif;
?>
<h3><img src="<?=$staticvars['site_path'].'/modules/congressos';?>/images/adcionar.gif" /> Adcionar  P&aacute;ginas Web  </h3><br />
...
<table width="350" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td align="center"><img src="<?=$staticvars['site_path'];?>/modules/congressos/images/template_example1.gif" width="294" height="66" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center"><img src="<?=$staticvars['site_path'];?>/modules/congressos/images/template_example2.gif" width="315" height="123" /></td>
  </tr>
