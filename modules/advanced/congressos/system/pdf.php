...
<link rel="stylesheet" media="all" type="text/css" href="<?=$staticvars['site_path'];?>/modules/congressos/system/print.css"  />
</head>
<body>
...
echo '<div style="font-family:\'Times New Roman\', Times, serif;font-size:medium">';
	echo '<div align="center"><h2>'.$title.'</h2><br>'.$cl[0].': '.$theme.'<br><font style="font-size:small">'.$authors.'</font></div>';
echo '</div>';
echo '<div align="left" style="font-family:\'Times New Roman\', Times, serif"><strong>'.$cl[1].'</strong><br>'.$abstract.'<br><br><br><font style="font-size:small"><strong>'.$cl[2].':</strong>'.$keywords.'</font><hr size="1"></div>';
else:
	echo $cl[16];
endif;
?>
