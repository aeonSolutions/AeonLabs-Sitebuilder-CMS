...
<table width="100%" border="0">
  ...
  <tr>
    <td colspan="2" class="header_text_2">Daily referral top </td>
  </tr>
 <?php
 for ($i=0;$i<count($ref);$i++): 
	...
	?>
	  <tr>
		...
		<td class="body_text"><a class="body_text" href="<?=$ref[$i][0];?>" target="_blank"><?=$text;?></a><br />
		(today:<?=$ref[$i][1];?>;total:<?=$ref[$i][2];?>)</td>
	  </tr>
	<?php
endfor;
?>
...
<table width="100%" border="0">
  ...
  <tr>
    <td><img src="<?=$staticvars['site_path'];?>/modules/actions/images/slink.gif" width="16" height="16" alt="Link"></td>
    <td class="body_text">No referrals today</td>
  </tr>
</table>
<?php
endif;
