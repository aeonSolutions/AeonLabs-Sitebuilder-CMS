...
isset($_POST['receivername']) and isset($_POST['receiveremail']) and $_POST['receiveremail']<>'' and $_POST['receivername']<>''):
	...
	$info=$_POST['message'];
	$subject='Email de sugest&atilde;o do site:'.$site_name.' enviado por '.$_POST['sendername'];
...
<table width="500"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2"><span class="style5">Invitation Email sent by  '.$_POST['sendername'].'(&nbsp;'.$_POST['senderemail'].'&nbsp;)</span></td>
  </tr>
  <tr>
    <td width="100">&nbsp;</td>
    <td class="style6"> '.$_POST['sendername'].' invites you to visit '.$site_name.' website <br>
      <br />
	'.$meta_description.'... and much more. Click on the following linkand get to know us!<br>
	<a href="'.$staticvars['site_path'].'/index.php" targuet="_blank">'.$staticvars['site_path'].'</a><br />
	<br />
	Apreciate your visit,<br>
	best regards, <br />
	'.$site_name.'
	team.</td>
  </tr>
