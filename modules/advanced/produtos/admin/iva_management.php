...
if(isset($_POST['iva_valor']) or isset($_POST['del'])):
	include($staticvars['local_root'].'kernel/staticvars.php');
	include($staticvars['local_root'].'modules/produtos/update_db/iva_management.php');
endif;
...
<link rel="StyleSheet" href="<?=$staticvars['site_path'];?>/core/java/dtree.css" type="text/css" />
      <DIV class="main-box">
      	<DIV class="main-box-title">Gest&atilde;o de I.V.A.</DIV>
		<DIV class="main-box-data">
			<TABLE width="100%" border="0" cellPadding="0" cellSpacing="0" height="350">
			  <tr valign="top">
				...
				<br>
					...
					<select size="1" name="ut" class="form_input">
						<?php
							$query=$db->getquery("select cod_iva, valor, descricao from produtos_iva");
							$selected=0;
							$option[0][0]='';
							$option[0][1]='-----------------';
							if($query[0][0]<>''):
			  ...
			  <tr valign="top">
				...
				<?php
				if ($code<>''):
					$query=$db->getquery("select cod_iva, valor, descricao from produtos_iva where cod_iva='".$code."'");
					if ($query[0][0]<>''):
...
include($staticvars['local_root'].'kernel/staticvars.php');
$query_a=$db->getquery("select cod_iva, valor, descricao from produtos_iva where cod_iva='".$mod."'");
if ($query_a[0][0]==''):
	no_code();
	return;
endif;
  ...
  <tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" align="center">
	  <tr>
		...
		<font class="body_text"><strong>Código I.V.A: <?=$query_a[0][0];?></strong></font>		</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		<td colspan="2">
			<font class="body_text">Descricao</font>&nbsp;&nbsp;&nbsp;
			<input type="text" name="iva_descricao" value="<?=$query_a[0][2];?>" maxlength="255" size="40">		</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		<td colspan="2">
			<font class="body_text">Valor (%)</font>&nbsp;&nbsp;&nbsp;
			<input type="text" name="iva_valor" value="<?=$query_a[0][1];?>" maxlength="255" size="40">		</td>
	  </tr>
	  <tr>
	    <td align="right">&nbsp;</td>
	    </tr>
    ...
    <td valign="bottom" align="left">
		<form method="post" action="<?=$address.'&mod='.$mod;?>"  enctype="multipart/form-data">
		  &nbsp;&nbsp;<input type="hidden" name="del_iva" value="<?=$query_a[0][0];?>">
	...
	<table border="0" cellpadding="0" cellspacing="0" align="center">
	  <tr>
		<td colspan="2">
			...
			<input type="text" name="iva_descricao" maxlength="255" value="" size="40">
		</td>
	  </tr>
	  <tr>
		<td height="5" colspan="2"></td>
	  ...
	  <tr>
		<td colspan="2">
			<font class="body_text">Valor (%)</font>&nbsp;&nbsp;&nbsp;
			<input type="text" name="iva_valor" maxlength="255" value="%" size="40">
		</td>
	  </tr>
	  <tr>
		<td height="5" colspan="2"></td>
