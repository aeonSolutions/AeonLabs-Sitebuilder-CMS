...
$posts=$db->getquery("select cod_topic, cod_forum, assunto, mensagem,reply_to from forum_topic order by data ASC limit 0,3");
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="110"><a href="<?=session($staticvars,'index.php?id='.$forum_id);?>"><img src="<?=$staticvars['site_path'].'/modules/forum/images/'.$lang.'/forum_eng.gif';?>" border="0"/></a></td>
    <td align="right" class="body_text">Last posts added in the forum  </td>
  </tr>
  <tr>
    <td colspan="2" class="body_text"><br>
	<?php
	if($posts[0][0]<>''):
