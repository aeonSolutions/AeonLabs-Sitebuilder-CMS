...
<script type="text/javascript"
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
        ...
        <tr>
          <td colspan="2" class="Header_text_1" height="25" nowrap="nowrap" align="center">&nbsp;Topics&nbsp;</td>
          <td width="100%" class="Header_text_1" nowrap="nowrap" align="center">&nbsp;Posts&nbsp;</td>
          <td width="100%" class="Header_text_1" nowrap="nowrap" align="center">Author</td>
          <td width="100%" class="Header_text_1" nowrap="nowrap" align="center">&nbsp;Views&nbsp;</td>
