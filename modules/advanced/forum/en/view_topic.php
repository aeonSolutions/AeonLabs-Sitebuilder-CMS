...
<script type="text/javascript"
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
	    ...
	    <table width="100%" cellpadding="5" cellspacing="1" border="0" style="background-color: #FFFFFF; border: 2px #006699 solid; ">
          <tr>
            <td width="150" height="25" align="center" nowrap="nowrap" class="Header_text_1">&nbsp;Author&nbsp;</td>
            <td align="center" nowrap="nowrap" class="Header_text_1">&nbsp;Message&nbsp;</td>
          </tr>
          
		  <tr>
		    <td width="150" height="50" align="left" valign="middle" bgcolor="#EFEFEF" class="body_text">
	        <?php
			...
			echo $user_name[0][0].'<br>Member since:<br>&nbsp;&nbsp;'.date ('d M Y',strtotime($user_name[0][1]));
			?></td>
            <td valign="top" align="left" class="body_text" bgcolor="#EFEFEF">Posted on :<?=date ('d M Y',strtotime($forum_topics[0][4]));?>&nbsp;&nbsp;Subject:
              <?=$forum_topics[0][2];?> 
			  <HR noShade SIZE=1>
          ...
          <tr>
            ...
            <font color="#006699">Back to top</font></a></td>
		  ...
		  <tr>
			...
			?></td>
            <td valign="top" align="left" class="body_text" bgcolor="<?=$color;?>">Posted on:<?=date ('d M Y',strtotime($forum_topics[0][4]));?>&nbsp;&nbsp;Subject:<?=$posts[$i][2];?> 
			  <HR noShade SIZE=1>
	    ...
	    <table width="100%"  border="0" cellspacing="3" cellpadding="0">
		  ...
		  <td colspan="3" align="right">
			...
			<input type="image" src="images/buttons/en/ver.gif" name="user_input">
			</form>
		  </td>
		  </tr>
		</table></TD>
