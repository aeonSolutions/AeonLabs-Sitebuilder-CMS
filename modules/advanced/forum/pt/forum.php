		...
		<td>
	      <table cellSpacing="0" cellPadding="0" width="100%" border="0">
			<tr>
			  ...
			  <td width="70" align=right vAlign=bottom noWrap><font class="body_text"><A href="<?=session($staticvars,'index.php');?>">Voltar</A></font></td>
			</tr>
		</table>
      <HR noShade SIZE=1>
      </td>
	...
	<TR>
	  ...
	  <table width="90%" border="0" align="center" cellpadding="2" cellspacing="1" style="background-color: #FFFFFF; border: 2px #006699 solid; ">
        <tr>
          ...
          <td width="100%" class="Header_text_1" nowrap="nowrap" align="center">&nbsp;T&oacute;picos&nbsp;</td>
		  ...
		  if ($forum_cats[0][0]<>''):
			$color='#C4D7FF';
			  for($i=0; $i<count($forum_cats);$i++):
				?>
				<tr bgcolor="#9999FF">
				  <td height="28" colspan="5" align="left" class="header_text_2">
					<?=$forum_cats[$i][1];?></td>
		  		</tr>
				<?php
				...
				if ($forums[0][0]<>''):
					...
					<tr>
					  ...
					  <td width="100%" height="50" align="left" bgcolor="<?=$color;?>" class="row1"> <a href="<?=session($staticvars,'index.php?id='.$task.'&view='.$forums[$j][0]);?>" class="header_text_2">
						<?=$forums[$j][1];?></a><br>
					  ...
					  <td align="center" valign="middle" height="50" nowrap="nowrap" class="body_text" bgcolor="<?=$color;?>">
						<?=$user_name;?><br>
						<?=$put_date;?>
					  </td>
					</tr>
