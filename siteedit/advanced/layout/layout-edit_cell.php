...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<font class="header_text_1">&nbsp;Edit</font>
	</td>
  </tr>
  <tr>
    <td colspan="2" align="center">
	  <form class="form" method="post" action="<?=$_SERVER['REQUEST_URI'];?>"  enctype="multipart/form-data">
		...
		if ($query[0][0]==''):
			...
			<tr>
			  ...
			  <input type="hidden" value="<?=$mod;?>" id="mod" name="mod" />
  ...
  <tr>
    <td colspan="2" align="left">Add</td>
  </tr>
  <tr>
    <td colspan="2" align="center">
	  <form class="form" method="post" action="<?=$_SERVER['REQUEST_URI'];?>"  enctype="multipart/form-data">
		<table height="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
			  <td height="5" align="right">
			  <input type="hidden" value="<?=$mod;?>" name="mod" id="skin" />
			  <input type="hidden" value="<?=$skin;?>" id="skin" name="skin" />
  ...
  <tr>
    <td colspan="2" align="left">
	<font class="header_text_1">&nbsp;Delete</font>
	</td>
  </tr>
  <tr>
    <td colspan="2" align="center">
  ...
  <tr>
    <td colspan="2" align="center">
	  <form class="form"  method="post" action="<?=strip_address("skin",strip_address("mod",$_SERVER['REQUEST_URI'])).'&skin='.$skin;?>"  enctype="multipart/form-data">
		<table height="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td height="5" align="right">
			  <input type="hidden" value="<?=$skin;?>" id="skin "name="skin" />
