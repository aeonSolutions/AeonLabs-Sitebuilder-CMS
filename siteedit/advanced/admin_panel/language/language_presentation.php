...
if ((isset($_POST['dl']) or isset($_POST['fl']))and !isset($_POST['continue'])):
	save_settings_language($local_root);
endif;

if (is_file($local_root.'kernel/settings/language.php')):
	include($local_root.'kernel/settings/language.php');
	if ($lang_type=='flags'):
    ...
    <td width="85%">
		<form method="post" name="general_settings" action="<?=$_SERVER['REQUEST_URI'];?>"  enctype="multipart/form-data">
		  <table border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
			  <td colspan="2" style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:medium; font-weight:bold"><img src="<?=$globvars['site_path'];?>//images/design.jpg">&nbsp;Language selector
...
function save_settings_language($local_root){
include($local_root.'general/staticvars.php');
$filename=$local_root.'kernel/settings/language.php';
