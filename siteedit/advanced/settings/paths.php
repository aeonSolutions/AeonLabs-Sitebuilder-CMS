...
<table width="100%" border="0">
  <tr>
    <td><h3><img src="<?=$globvars['site_path'];?>/images/paths.gif" alt="Paths">&nbsp;PATHS</h3>
    </td>
...
<form name="form_paths" id="form_paths" class="form" action="<?=strip_address("set",$_SERVER['REQUEST_URI']);?>"  onsubmit="return checkform(this)" enctype="multipart/form-data" method="post">
  <p>
  <h4 id="t_url">URL Address</h4>
<input onchange="cleanform(document.form_paths);" name="site_path" type="text" class="text" id="site_path" value="<?=$staticvars['site_path'];?>" size="50">
    <br>
    <h4 id="t_root">Site location</h4>
    <input onchange="cleanform(document.form_paths);" name="local_root" type="text" class="text" id="local_root" value="<?=$staticvars['local_root'];?>" size="50">
    <br>
    <h4 id="t_upload">Uploads Directory</h4>
    <input onchange="cleanform(document.form_paths);" name="upload" type="text" class="text" id="upload" value="<?=$staticvars['upload'];?>" size="60">
    <br>
    <br>
  </p>
  <p align="right">
