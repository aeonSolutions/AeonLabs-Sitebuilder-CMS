...
elseif(isset($_POST['features'])):
	...
	$result=mysql_query("select id from search_spiders");
	if (!mysql_error($linker)): // table  found
	    $result=mysql_query("drop table 'search_spiders'");
	endif;
	mysql_close($linker);
	if (is_file($globvars['site']['directory'].'kernel/search_spiders.php')):
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
			  <td align="right" valign="bottom">
					<input type="hidden" name="features" value="feat" /><input type="submit" value="Save Settings" class="button" name="save"></td>
			</tr>
		  </table>
	    </form>
	</td>
