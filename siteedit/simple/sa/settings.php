  ...
  <table width="100%" border="0" align="center">
    ...
    <tr>
      ...
      <td><h4 id="t_name">Site Name<br />
          <input class="text" value="<?=$staticvars['site_name'];?>" onchange="cleanform(document.form_settings)" name="name" type="text" id="name" tabindex="1" size="40" maxlength="80" /></h4>
    ...
    <tr>
      ...
      <td><h4 id="t_lang">Main language&nbsp;<br />
          <input class="text" onchange="cleanform(document.form_settings)"  name="main_lang" value="<?=$staticvars['language']['main'];?>" value="pt" type="text" id="main_lang" tabindex="3" size="50" maxlength="2" />
      </h4>
    ...
    <tr>
      ...
      <td><h4 id="t_avail_lang">Available languages<br />
          <input class="text" onchange="cleanform(document.form_settings)"  name="avail_lang" value="<?=$staticvars['language']['available'];?>" type="text" id="avail_lang" tabindex="3" size="50" maxlength="255" />
      </h4>
