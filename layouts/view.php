...
$local_root = __FILE__ ;
$local_root = ''.substr( $local_root, 0, strpos( $local_root, $globvars['directory_name'] ) ) ;
include($local_root.$globvars['directory_name'].'/copyfiles/advanced/general/db_class.php');
include($local_root.$globvars['directory_name'].'/core/globvars.php');
