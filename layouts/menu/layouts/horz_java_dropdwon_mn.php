...
$sub_menu_bk='#990000';
$sub_menu_highlight='#cc6666';
$sub_menu_txt='#FFFFFF';
$sub_menu_txt_highlight='#FFFFFF';
$sub_menu_border='#cc6666';
		...
		if ($menu_name<>''):
			for($i=0; $i<count($menu_name); $i++):
				...
				if ($menu_name[$i]['type']=='menu'):
					...
					<img style="display:inline" src="'.$staticvars['site_path'].'/layout/menu/layouts/horz_fire/seta.gif" width="12" height="12" border="0">&nbsp;'.$tree[$menu_name[$i]['pos']]['name'].'&nbsp;&nbsp;&nbsp;</a>
					';
				else:
					echo '<a class="menu_links" id="'.$menu_name[$i]['id'].'" href="'.$tree[$menu_name[$i]['pos']]['link'].'" target="_top">
					<img style="display:inline" src="'.$staticvars['site_path'].'/layout/menu/layouts/horz_fire/seta.gif" width="12" height="12" border="0">&nbsp;'.$tree[$menu_name[$i]['pos']]['name'].'&nbsp;&nbsp;&nbsp;</a>
