...
function build_menu($staticvars){
	...
	$query=$db->getquery("select cod_menu, name, link, cod_module,aditional_params,display_name from menu where active='s' and cod_user_type='".$staticvars['users']['group']."' and cod_sub_menu='0' order by priority ASC");    
   	if ($query[0][0]==''):
