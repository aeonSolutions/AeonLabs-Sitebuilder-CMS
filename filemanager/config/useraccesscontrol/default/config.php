<?
	$CONFIG['root_path'] = $globvars['site']['directory'];//This variable corresponds to the user files main directory, that will be showed by the filemanager application. Each action will be related with the subfiles of this folder. This path is relative to the "interfacelevel/" directory.
	$CONFIG['root_path_name'] = $globvars['site']['name'];
