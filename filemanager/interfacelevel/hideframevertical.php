...
<link href="<?=$globvars['site_path'];?>/filemanager/interfacelevel/css/framesettools.css" rel="stylesheet" type="text/css" media="all" />
<script language="javascript" type="text/javascript" src="<?=$globvars['site_path'];?>/filemanager/interfacelevel/jscripts/framesettoolsvertical.js"></script>
...
<body class="body_vertical" onLoad="MM_preloadImages('<?=$globvars['site_path'];?>/filemanager/interfacelevel/images/tool_frame_left_on.png','<?=$globvars['site_path'];?>/filemanager/interfacelevel/images/tool_frame_right_on.png');">
<?
